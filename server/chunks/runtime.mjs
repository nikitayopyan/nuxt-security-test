...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "795b5be1-3647-418e-81cc-ace6bceb1c31"
  }
};
...
storage$1.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/oleggrozniy/vaimo/nuxt-security-test/nuxt-security-test/.data/kv"}));
...
const _OKc4DJSh6Z = defineNitroPlugin(async (nitroApp) => {
...
const _P4Gpf9xjzb = defineNitroPlugin((nitroApp) => {
...
const sriHashes = {"/_nuxt/CkWPykJn.js":"sha384-1zLL6qc1uVOOZTq4cew01pfLW48X50ugaEKuuS0CC3CD+I0/Ewo83uU0qvIUAVj7","/_nuxt/Dvq1NYns.js":"sha384-idMgLl3M74sYLcWNfO2cEiRLy9o9QR9ZrWB6aj+HW5VNP4yZlHI+cpapsINeGUGK","/_nuxt/WRhAonUB.js":"sha384-32uaFUAVcfx2db1l8UNZJBgT1Hmtx10n9Hellv9NlFvJbknkUl1cDK9+p86Hh4XC","/_nuxt/entry.DDW8k9fj.css":"sha384-LQtZDVA2lJ2nMmJXdntE9LDa6j90BNteAXYpgUKi4RCSvltUdaOMoO/hYrjJNvFl","/_nuxt/error-404.JekaaCis.css":"sha384-gHCrnESD0b1EahDLvyoES6nVsCAXarT+q3tH9LMMoAPkKN9dYkNZOuq4XRQ6Kpaf","/_nuxt/error-500.CNP9nqm1.css":"sha384-QUlEKsyvajCiVJPQg7ARm44ngtog88rd7OPHhUv7WcxoI0UvhnYZWTcF6N8olPCy","/_nuxt/gF_lUhPx.js":"sha384-UOnllLGxxIUf24k3Q3534QKpgrbeZdoV/Y9wwD4qYOPV7v6opvthY/jEyqbepkj/","/favicon.ico":"sha384-udbcbVSoJ0jynxYo+FKdhmcYDst1ze6s6rkgFExSYfpX6tAuGn5whsHNjmcRr4eU"};

const _zDwTT9Xd8w = defineNitroPlugin((nitroApp) => {
  nitroApp.hooks.hook("render:html", (html, { event }) => {
    const rules = resolveSecurityRules(event);
...
const _YFK1hxaEDW = defineNitroPlugin((nitroApp) => {
  {
    return;
  }
});

const _6mebvNFSGz = defineNitroPlugin((nitroApp) => {
...
const _VKukwVpoTv = defineNitroPlugin((nitroApp) => {
...
const _792hvSM28p = defineNitroPlugin((nitroApp) => {
  nitroApp.hooks.hook("render:html", (html, { event }) => {
    const rules = resolveSecurityRules(event);
    if (!rules.enabled) {
      return;
    ...
    if (rules.ssg && rules.ssg.meta && rules.headers && rules.headers.contentSecurityPolicy && false) {
...
const _yEl416MVbg = defineNitroPlugin((nitroApp) => {
...
const _d9THWEpKht = defineNitroPlugin((nitroApp) => {
...
const _whk1jhczDd = defineNitroPlugin(async (nitroApp) => {
  {
...
const assets = {
  "/favicon.ico": {
    ...
    "mtime": "2024-05-12T10:40:22.275Z",
    "size": 4286,
    "path": "../public/favicon.ico"
  },
  "/_nuxt/CkWPykJn.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1cd3-v8Xm2OsMaXn6ndfxZmxz2SB2XwY\"",
    "mtime": "2024-05-12T10:40:22.274Z",
    "size": 7379,
    "path": "../public/_nuxt/CkWPykJn.js"
  },
  "/_nuxt/Dvq1NYns.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"ab3-0xKahubW8d53qCB5YCRU0ni94wQ\"",
    "mtime": "2024-05-12T10:40:22.274Z",
    "size": 2739,
    "path": "../public/_nuxt/Dvq1NYns.js"
  },
  "/_nuxt/WRhAonUB.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3980b-x49isjhF8y/RTz7IYYso+Yh8rpw\"",
    "mtime": "2024-05-12T10:40:22.274Z",
    "size": 235531,
    "path": "../public/_nuxt/WRhAonUB.js"
  },
  ...
  "/_nuxt/gF_lUhPx.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"191-i5BaKOcGxIJKOHjiZOOxhwxXAec\"",
    "mtime": "2024-05-12T10:40:22.274Z",
    "size": 401,
    "path": "../public/_nuxt/gF_lUhPx.js"
  },
  "/_nuxt/builds/latest.json": {
    "type": "application/json",
    "etag": "\"47-UnhgjwVQUXq3fI34LlrZnK9+ZEs\"",
    "mtime": "2024-05-12T10:40:22.272Z",
    "size": 71,
    "path": "../public/_nuxt/builds/latest.json"
  },
  "/_nuxt/builds/meta/795b5be1-3647-418e-81cc-ace6bceb1c31.json": {
    "type": "application/json",
    "etag": "\"8b-eOF0Zm+MaOh6A3dIJ8bFhssDJKE\"",
    "mtime": "2024-05-12T10:40:22.269Z",
    "size": 139,
    "path": "../public/_nuxt/builds/meta/795b5be1-3647-418e-81cc-ace6bceb1c31.json"
  }
};
...
const _NWSVED = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _JV5VpT = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _6kU2Lp = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _mee7ZE = defineEventHandler(async (event) => {
  const rules = resolveSecurityRules(event);
...
const _h77dbU = defineEventHandler(async (event) => {
  const rules = resolveSecurityRules(event);
...
const _lazy_uxP7bX = () => import('./routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_uxP7bX, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _NWSVED, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _JV5VpT, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _6kU2Lp, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _mee7ZE, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _h77dbU, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uxP7bX, lazy: true, middleware: false, method: undefined }
];
