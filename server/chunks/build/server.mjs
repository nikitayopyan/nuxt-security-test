import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, unref, useSSRContext, createApp, effectScope, reactive, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, n as joinURL, o as sanitizeStatusCode, q as createHooks, h as createError$1, r as isSamePath, t as toRouteMatcher, v as createRouter$1, x as defu } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-ChrYS_qd.mjs').then((m) => m.default || m)
  }
];
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-6dafedb2"]]);
const _sfc_main$2 = {};
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, useHead as c, useRoute as d, entry$1 as default, nuxtLinkDefaults as n, useRouter as u };
